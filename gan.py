...
def make_generator_model():
  ...
  model.add(tf.keras.layers.Conv2DTranspose(3*128, (3, 3), strides=(1, 1), padding='same'))
  model.add(tf.keras.layers.BatchNormalization())
  model.add(tf.keras.layers.Conv2DTranspose(3*64, (3, 3), strides=(2, 2), padding='same'))
  model.add(tf.keras.layers.BatchNormalization())
